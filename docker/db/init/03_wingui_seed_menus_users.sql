...
SELECT 'menu0000000000000000000000000001', NULL, 'MENU_UTIL', '', 90, '', 'Y', 'system', GETDATE()
 WHERE NOT EXISTS (SELECT 1 FROM dbo.TB_AD_MENU WHERE MENU_CD = 'MENU_UTIL');

INSERT INTO dbo.TB_AD_MENU (ID, PARENT_ID, MENU_CD, MENU_PATH, MENU_SEQ, MENU_FILE_PATH, USE_YN, CREATE_BY, CREATE_DTTM)
SELECT 'menu0000000000000000000000000002', NULL, 'MENU_DP',   '', 20, '', 'Y', 'system', GETDATE()
 WHERE NOT EXISTS (SELECT 1 FROM dbo.TB_AD_MENU WHERE MENU_CD = 'MENU_DP');

INSERT INTO dbo.TB_AD_MENU (ID, PARENT_ID, MENU_CD, MENU_PATH, MENU_SEQ, MENU_FILE_PATH, USE_YN, CREATE_BY, CREATE_DTTM)
SELECT 'menu0000000000000000000000000003', NULL, 'MENU_MP',   '', 30, '', 'Y', 'system', GETDATE()
 WHERE NOT EXISTS (SELECT 1 FROM dbo.TB_AD_MENU WHERE MENU_CD = 'MENU_MP');

INSERT INTO dbo.TB_AD_MENU (ID, PARENT_ID, MENU_CD, MENU_PATH, MENU_SEQ, MENU_FILE_PATH, USE_YN, CREATE_BY, CREATE_DTTM)
SELECT 'menu0000000000000000000000000004', NULL, 'MENU_FP',   '', 50, '', 'Y', 'system', GETDATE()
 WHERE NOT EXISTS (SELECT 1 FROM dbo.TB_AD_MENU WHERE MENU_CD = 'MENU_FP');

INSERT INTO dbo.TB_AD_MENU (ID, PARENT_ID, MENU_CD, MENU_PATH, MENU_SEQ, MENU_FILE_PATH, USE_YN, CREATE_BY, CREATE_DTTM)
SELECT 'menu0000000000000000000000000005', NULL, 'MENU_BF',   '', 10, '', 'Y', 'system', GETDATE()
 WHERE NOT EXISTS (SELECT 1 FROM dbo.TB_AD_MENU WHERE MENU_CD = 'MENU_BF');

INSERT INTO dbo.TB_AD_MENU (ID, PARENT_ID, MENU_CD, MENU_PATH, MENU_SEQ, MENU_FILE_PATH, USE_YN, CREATE_BY, CREATE_DTTM)
SELECT 'menu0000000000000000000000000006', NULL, 'MENU_IM',   '', 60, '', 'Y', 'system', GETDATE()
 WHERE NOT EXISTS (SELECT 1 FROM dbo.TB_AD_MENU WHERE MENU_CD = 'MENU_IM');

INSERT INTO dbo.TB_AD_MENU (ID, PARENT_ID, MENU_CD, MENU_PATH, MENU_SEQ, MENU_FILE_PATH, USE_YN, CREATE_BY, CREATE_DTTM)
SELECT 'menu0000000000000000000000000007', NULL, 'MENU_RP',   '', 40, '', 'Y', 'system', GETDATE()
 WHERE NOT EXISTS (SELECT 1 FROM dbo.TB_AD_MENU WHERE MENU_CD = 'MENU_RP');

INSERT INTO dbo.TB_AD_MENU (ID, PARENT_ID, MENU_CD, MENU_PATH, MENU_SEQ, MENU_FILE_PATH, USE_YN, CREATE_BY, CREATE_DTTM)
SELECT 'menu0000000000000000000000000008', NULL, 'MENU_SA',   '', 70, '', 'Y', 'system', GETDATE()
 WHERE NOT EXISTS (SELECT 1 FROM dbo.TB_AD_MENU WHERE MENU_CD = 'MENU_SA');

INSERT INTO dbo.TB_AD_MENU (ID, PARENT_ID, MENU_CD, MENU_PATH, MENU_SEQ, MENU_FILE_PATH, USE_YN, CREATE_BY, CREATE_DTTM)
SELECT 'menu0000000000000000000000000009', NULL, 'MENU_AD',   '', 80, '', 'Y', 'system', GETDATE()
...
SELECT v.LANG_CD, v.LANG_KEY, v.LANG_VALUE, 'system', GETDATE()
  FROM (VALUES
    ('ko','MENU_UTIL', N'유틸리티'),     ('en','MENU_UTIL', 'Utility'),       ('ja','MENU_UTIL', N'ユーティリティ'), ('zh','MENU_UTIL', N'实用工具'),
    ('ko','MENU_DP',   N'수요계획'),     ('en','MENU_DP',   'Demand Plan'),   ('ja','MENU_DP',   N'需要計画'),       ('zh','MENU_DP',   N'需求计划'),
    ('ko','MENU_MP',   N'기준계획'),     ('en','MENU_MP',   'Master Plan'),   ('ja','MENU_MP',   N'マスタープラン'), ('zh','MENU_MP',   N'主计划'),
    ('ko','MENU_FP',   N'공장계획'),     ('en','MENU_FP',   'Factory Plan'),  ('ja','MENU_FP',   N'工場計画'),       ('zh','MENU_FP',   N'工厂计划'),
    ('ko','MENU_BF',   N'기준예측'),     ('en','MENU_BF',   'Baseline Forecast'), ('ja','MENU_BF', N'ベースライン予測'), ('zh','MENU_BF', N'基线预测'),
    ('ko','MENU_IM',   N'재고관리'),     ('en','MENU_IM',   'Inventory'),     ('ja','MENU_IM',   N'在庫管理'),       ('zh','MENU_IM',   N'库存管理'),
    ('ko','MENU_RP',   N'보충계획'),     ('en','MENU_RP',   'Replenishment'), ('ja','MENU_RP',   N'補充計画'),       ('zh','MENU_RP',   N'补充计划'),
    ('ko','MENU_SA',   N'판매집계'),     ('en','MENU_SA',   'Sales'),         ('ja','MENU_SA',   N'販売集計'),       ('zh','MENU_SA',   N'销售'),
    ('ko','MENU_AD',   N'시스템관리'),   ('en','MENU_AD',   'Admin'),         ('ja','MENU_AD',   N'システム管理'),   ('zh','MENU_AD',   N'系统管理')
...
SELECT 'user0000000000000000000000000001', 'composer-dev',
       'NOT_USED_DEV_BYPASS', N'Composer Dev', 'dev@composer.local', 'Y', 'system', GETDATE()
...
SELECT 'grp00000000000000000000000000001', 'GRP_ADMIN', N'시스템관리자', 'Y', 'system', GETDATE()
 WHERE NOT EXISTS (SELECT 1 FROM dbo.TB_AD_GROUP WHERE GRP_CD = 'GRP_ADMIN');

PRINT '[03] wingui seed (parent menus + dev user) ready.';
GO
