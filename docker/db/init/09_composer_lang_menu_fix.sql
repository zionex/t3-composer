...
UPDATE TB_AD_MENU
SET    MENU_PATH      = N'/util/t3composer',
       MENU_FILE_PATH = N'/util/T3Composer',
       MODIFY_BY      = N'system',
       MODIFY_DTTM    = GETDATE()
...
SELECT
    REPLACE(NEWID(), '-', ''),
    ID,
    N'UI_UT_COMPOSER_PATTERNS',
    N'/util/t3composerpatterns',
    3,
    'Y',
    N'system',
...
INSERT INTO TB_AD_LANG_PACK (LANG_CD, LANG_KEY, LANG_VALUE) VALUES ('ko', 'UI_UT_COMPOSER_PATTERNS', N'화면 패턴 관리');
INSERT INTO TB_AD_LANG_PACK (LANG_CD, LANG_KEY, LANG_VALUE) VALUES ('en', 'UI_UT_COMPOSER_PATTERNS', N'Screen Patterns');
INSERT INTO TB_AD_LANG_PACK (LANG_CD, LANG_KEY, LANG_VALUE) VALUES ('ja', 'UI_UT_COMPOSER_PATTERNS', N'画面パターン管理');
INSERT INTO TB_AD_LANG_PACK (LANG_CD, LANG_KEY, LANG_VALUE) VALUES ('zh', 'UI_UT_COMPOSER_PATTERNS', N'屏幕模式管理');
