...
-- 기존엔 .env 의 COMPOSER_WINGUI_REF_PATH / COMPOSER_DATABASE_REF_PATH 가 단일 글로벌 마운트로
-- 모든 Target 에 공유. 이제는 Target 별로 다른 wingui/database 폴더를 가리킬 수 있게 함.
--
...
--   값이 비어있으면 app.composer.wingui-ref-path / database-ref-path (글로벌 fallback) 사용.
